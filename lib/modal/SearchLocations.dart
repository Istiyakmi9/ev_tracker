class SearchLocations {
  ...
  SearchLocations({this.results, this.status});

  SearchLocations.fromJson(Map<String, dynamic> json) {
...
class Viewport {
  SearchLocation? northeast;
  SearchLocation? southwest;

  Viewport({this.northeast, this.southwest});

  Viewport.fromJson(Map<String, dynamic> json) {
    northeast = json['northeast'] != null
        ? SearchLocation.fromJson(json['northeast'])
        : null;
    southwest = json['southwest'] != null
        ? SearchLocation.fromJson(json['southwest'])
        : null;
  }
